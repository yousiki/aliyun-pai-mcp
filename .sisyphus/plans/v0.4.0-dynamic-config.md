...
- [ ] 2. DI Refactor — Replace `settings: Settings` with `configStore: ConfigStore`
...
- [ ] 3. Remove Codesource Tools + Deprecate codeCommit
...
- [ ] 4. New Tools: pai_config_schema + pai_config_update
...
- [ ] 5. Server Instructions + pai_help Tool
