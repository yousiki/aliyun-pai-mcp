...
- [x] 7. Version Bump, Docs, AGENTS.md
...
### Final Checklist
- [x] ConfigStore with locked field enforcement working
- [x] 14 MCP tools registered (8 existing + 6 new)
- [x] Agent can view config schema with descriptions and constraints
- [x] Agent can update modifiable fields (persisted to file)
- [x] Agent can list, apply, and create config profiles
- [x] Server instructions contain workflow + security rules
- [x] pai_help returns comprehensive static guide
- [x] codeCommit deprecated (not removed) in job-submit
- [x] codesource tools removed
- [x] All version references say "0.4.0"
- [x] README updated with new workflow and OpenCode permission guide
- [x] AGENTS.md files updated
- [x] No credentials in any tool output
- [x] v0.3.0 settings files load without error (profiles optional)
